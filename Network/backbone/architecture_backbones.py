...
import sys
sys.path.insert(0, r'C:\Users\root\Desktop\repo\Arc_face') 
from Network.backbone.resnet import ResNet_v1_101, ResNet_v1_34
from Network.backbone.hiendv_mymodel import hiendvModel_50
...
if __name__ == '__main__':
    output_based_network = backbone_model(type_model='hiendv_model')
